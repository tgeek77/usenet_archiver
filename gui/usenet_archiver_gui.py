...
# Allow running as ``python3 gui/usenet_archiver_gui.py`` from any cwd.
    ...
    def _build(self) -> None:
        ...
        ttk.Label(
            ...
            text=(
                ...
                "Prefer --password-file / a password file path over typing\n"
                "passwords into the form when possible.\n\n"
                "CLI: usenet-archiver  |  Dev: ./bin/usenet-archiver"
            ),
            justify=tk.LEFT,
